...
exports.runSync = exports.executeAsync = exports.executeSync = exports.hasWdioSyncSupport = exports.wrapCommand = exports.runFnInFiberContext = exports.executeHooksWithArgs = exports.switchSyncFlag = exports.runAsync = void 0;
...
let wrapCommand = function wrapCommand(commandName, fn) {
    ...
    return function (...args) {
         ...
         */
        const command = hasWdioSyncSupport && wdioSync && !exports.runAsync
